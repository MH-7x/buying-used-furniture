...
const services = [
  {
    icon: Home,
    title: "شراء اثاث المنزلي المستعمل",
    href: "/شراء-الأثاث-المنزلي",
    description:
      "نشتري جميع أنواع اثاث المنزلي من غرف النوم والمعيشة والمجالس العربية والكنب والستائر والسجاد",
  },
  {
    icon: Zap,
  ...
  {
    icon: Briefcase,
    title: "شراء اثاث المكتبي المستعمل",
    href: "/شراء-الاثاث-المكتبي-المستعمل",
    description: "خدمة شراء اثاث المكتبي بالجملة للشركات والمكاتب والمؤسسات",
  },
  {
    icon: Hotel,
    title: "شراء اثاث الفنادق المستعمل",
    href: "/شراء-اثاث-فنادق-مستعمل",
    description:
      "نشتري اثاث الفنادق بكميات كبيرة بما فيها الأسرّة والأرائك ومعدات الضيافة",
  },
  {
    icon: Monitor,
...
export const metadata = MetadataTemplate({
  data: {
    meta: {
      ...
      desc: "شركة شراء اثاث مستعمل في دبي والإمارات. نشتري اثاثك المنزلي والمكتبي والأجهزة الكهربائية بأسعار عادلة وشفافية تامة. خدمة 24/7 مع نقل مجاني وتقييم فوري.",
    },
    image: {
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-right">
              ...
              <p className="text-lg text-gray-300 mb-8 leading-relaxed max-w-xl mx-auto lg:mx-0">
                شريكك الأول في بيع وشراء اثاث المستعمل بالإمارات. نتعامل بصدق
                وشفافية من مقرنا الرئيسي في دبي.
              </p>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <div className="space-y-4 text-[#606060] leading-relaxed">
                ...
                <p>
                  شركتنا ليست مجرد شركة نقل اثاث أو وسيط عادي. نحن متخصصون في
                  تجارة اثاث المستعمل بكل أنواعه. نفهم السوق جيداً ونعرف القيمة
                  الحقيقية لكل قطعة اثاث.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 bg-white rounded-2xl p-8 shadow-lg">
            <p className="text-[#606060] leading-relaxed text-center">
              كثير من تجار اثاث المستعمل يشترون بأسعار منخفضة جداً ثم يبيعون
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-[#606060] mt-4 max-w-2xl mx-auto">
              نقدم مجموعة شاملة من خدمات شراء اثاث المستعمل والأجهزة المنزلية في
              جميع إمارات الدولة
            </p>
          </div>
              ...
              <div className="space-y-6 mt-10">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm leading-relaxed">
                      كل قطعة اثاث تمر بعملية فحص احترافية شاملة للحالة الهيكلية
                      والمظهرية
                    </p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm leading-relaxed">
                      اثاث المنجد يخضع لبروتوكول تعقيم احترافي خاص يضمن خلوه من
                      الحشرات والبكتيريا
                    </p>
                  </div>
                </div>
            ...
            <Card className="bg-primary border-0 rounded-3xl overflow-hidden">
              <CardContent className="p-8 lg:p-10">
                ...
                <p className="text-[#606060] leading-relaxed mb-6">
                  عندما تبيع اثاثك لنا، لا تحتاج للقلق بشأن كيفية نقله أو
                  تفكيكه. نحن نتولى كل شيء. فريقنا المتخصص يتعامل مع اثاثك
                  بعناية فائقة.
                </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div>
              ...
              <p className="text-[#606060] leading-relaxed mb-8">
                مقرنا الرئيسي في إمارة دبي وخدماتنا تمتد لتشمل جميع إمارات
                الدولة.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-4 text-[#606060] leading-relaxed">
                <p>
                  عملنا في شراء وبيع اثاث المستعمل ليس مجرد نشاط تجاري عادي. نحن
                  نساهم بشكل فعلي في بناء اقتصاد دائري يتماشى مع رؤية وأهداف
                  الاستدامة في دولة الإمارات العربية المتحدة.
                </p>
                <p>
                  كل قطعة اثاث نعيد تأهيلها ونبيعها مرة أخرى هي قطعة اثاث لم
                  تنتهِ في مكبات النفايات. نحن نساعد البائعين على تحويل اثاثهم
                  القديم إلى سيولة مالية فورية، وفي الوقت نفسه نوفر للمشترين
                  فرصة حقيقية للحصول على اثاث أنيق وعالي الجودة بأسعار أقل.
                </p>
              </div>
            </div>
            <div>
            ...
            <div className="order-1 lg:order-2">
              ...
              <div className="space-y-4 text-[#606060] leading-relaxed">
                ...
                <p>
                  ...
                  وإرسال صور لاثاثك للحصول على تقييم مبدئي سريع ومجاني.
                </p>
              </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="bg-[#faf8f7] rounded-3xl p-8 lg:p-12">
            ...
            <p className="text-[#606060] leading-relaxed">
              ...
              كنت تبيع اثاثك لأنك تنتقل إلى منزل جديد، أو تغادر البلاد، أو تجدد
              ديكور منزلك، أو تشتري اثاثاً مستعملاً لتأثيث شقتك الأولى في
      ...
      <section className="py-20 lg:py-28 bg-[#f5d7cc]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-secondary/80 mb-8 max-w-2xl mx-auto">
            احصل على تقييم مجاني لاثاثك. فريقنا في انتظار مكالمتك أو رسالتك على
