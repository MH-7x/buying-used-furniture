...
const areas = [
  {
    ...
    desc: "مجتمع فلل فاخرة يسكنه عدد كبير من الأجانب والمقيمين. اثاث هنا عادة من ماركات عالمية وبحالة ممتازة، وكثير من السكان يبيعون اثاثهم عند مغادرة الدولة.",
  },
  {
    name: "جزيرة المرجان (Al Marjan Island)",
    desc: "جزيرة اصطناعية فيها فنادق وشقق فاخرة. نجد فيها أجهزة حديثة واثاث عصري من السكان والمنشآت الفندقية.",
  },
  {
    name: "ميناء العرب (Mina Al Arab)",
    desc: "مجتمع سكني على الواجهة البحرية. اثاث عصري وحديث، وكثير من السكان ينتقلون بشكل متكرر مما يوفر فرصاً جيدة للبيع والشراء.",
  },
  {
    name: "الضيت (Al Dhait)",
    desc: "من أكبر المناطق السكنية العائلية في رأس الخيمة. معدل دوران اثاث مرتفع بسبب الكثافة السكانية الكبيرة.",
  },
  {
    name: "الجزيرة الحمراء (Al Jazeera Al Hamra)",
    desc: "منطقة سكنية متنامية باثاث متنوع بين الاقتصادي والمتوسط.",
  },
  {
    name: "منطقة الكورنيش",
...
const tips = [
  {
    title: "نظّف اثاث قبل التقييم",
    body: "اثاث النظيف يعطي انطباعاً أفضل بكثير ويُصوَّر بشكل أحسن. مسح بسيط بقطعة قماش مبللة أو تنظيف سريع بالمكنسة الكهربائية للكنب يفرق كثيراً في تقييم اثاث والعرض الذي ستحصل عليه. لا تحتاج تنظيفاً احترافياً — فقط اجعله يبدو مرتباً.",
  },
  {
  ...
  },
  {
    ...
    body: "اثاث ايكيا أو الدانوب أو هوم سنتر أو بان إمارات له قيمة سوقية محددة ومعروفة. أخبرنا بالماركة عندما تتواصل معنا. وإذا عندك فاتورة الشراء الأصلية أو كرت الضمان، أرسله معنا — هذا يرفع العرض لأنه يثبت أصل القطعة وعمرها الفعلي.",
  },
  {
    title: "أصلح العيوب البسيطة قبل البيع",
    body: "شد البراغي المرخية، أصلح السحّابات المكسورة، ثبّت الأرجل المفكوكة، اخلع الملصقات القديمة. إصلاحات بسيطة ما تكلفك شيئاً لكنها ترفع قيمة القطعة وتعطي انطباعاً بأن اثاث تم الاعتناء به.",
  },
  {
...
const breadcrumbSchema = generateBreadcrumbSchema([
  { name: "شراء اثاث مستعمل رأس الخيمة", path: "/شراء-اثاث-مستعمل-راس-الخيمة" },
]);
    ...
    <>
      ...
      <main className="overflow-hidden text-[#694c4c]">
        <LocHeroSection
          ...
          desc=" إذا كنت تبحث عن شراء اثاث مستعمل رأس الخيمة بسعر عادل وبدون تعقيدات، فأنت في المكان الصحيح. نحن في شركة شراء اثاث المستعمل نشتري جميع أنواع اثاث والأجهزة المستعملة من المنازل والشقق والفلل والمكاتب في كل مناطق رأس الخيمة — من قرية الحمراء وجزيرة المرجان إلى ميناء العرب والضيت وغيرها."
        />
        ...
        <section className="mx-auto max-w-4xl px-4 py-14 sm:px-6 lg:px-8">
          <p className="mb-5 leading-relaxed">
            لدينا أكثر من عشر سنوات خبرة في سوق اثاث مستعمل في الإمارات العربية
            المتحدة. مقرنا الرئيسي في شارع الاستقلال، أبو شغارة، الشارقة، ونقدم
            خدماتنا في جميع أنحاء الدولة. نعرف قيمة اثاثك الحقيقية ونقدم لك أفضل
            سعر ممكن مع دفع نقدي فوري واستلام مجاني من باب بيتك.
          </p>
          <p className="mb-5 leading-relaxed">
            الكثير من الناس في رأس الخيمة يرغبون ببيع اثاثهم المستعمل لأسباب
          ...
          <p className="leading-relaxed">
            هنا يأتي دورنا. تواصل معنا عبر واتساب، أرسل صور اثاثك، وخلال 5 إلى
            ...
            <div className="grid items-center gap-10 lg:grid-cols-2">
              ...
              <div>
                ...
                <p className="mb-4 leading-relaxed">
                  كثير من الناس يترددون قبل بيع اثاثهم المستعمل. السبب واضح:
                ...
                <p className="mb-4 leading-relaxed">
                  نحن لسنا شركة نقل تشتري اثاثك بأبخس الأسعار وتعيد بيعه بربح
                  كبير. نحن شركة متخصصة في شراء اثاث مستعمل نفهم السوق المحلي
                  ونعرف القيمة المتبقية في كل قطعة. عندنا طريقة تقييم واضحة
                  ومنهجية تعتمد على حالة القطعة وعلامتها التجارية وعمرها والطلب
                  عليها في السوق حالياً.
                </p>
                <p className="mb-4 leading-relaxed">
        ...
        <section className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
          ...
          <p className="mx-auto mb-12 max-w-3xl text-center leading-relaxed">
            نشتري جميع أنواع اثاث المستعمل تقريباً. سواء كنت تبيع قطعة واحدة أو
            تصفّي شقة كاملة أو فيلا أو مكتب أو حتى فندق، نحن مستعدون. لا نرفض أي
            نوع من اثاث ولا نشترط أن يكون بحالة ممتازة. هذه أبرز الفئات التي
            نتعامل معها يومياً:
          </p>
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            ...
            {[
              ...
              {
                title: "شراء اثاث الفلل والفنادق في رأس الخيمة",
                img: "/loc/شراء-أثاث-الفلل-والفنادق-في-رأس-الخيمة.jpg",
                alt: "شراء اثاث مستعمل رأس الخيمة - اثاث فلل وفنادق",
                href: "/شراء-اثاث-فنادق-مستعمل",
                text: "نتعامل أيضاً مع المشاريع الكبيرة. إذا كانت لديك فيلا كاملة تريد تصفيتها، أو فندق يجدد اثاثه، أو شركة تنتقل لمقر جديد — نحن قادرون على شراء كميات كبيرة في عملية واحدة. لدينا أسطول نقل وفريق عمل كافٍ للتعامل مع أي حجم.",
              },
            ].map((card) => (
              <article
                key={card.title}
            ...
            <div className="grid gap-8 md:grid-cols-3">
              ...
              <div className="relative rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm">
                ...
                <p className="mb-3 text-sm leading-relaxed text-white/80">
                  أرسل لنا صوراً للاثاث الخاصة بك الذي تريد بيعه عبر واتساب.
                  حاول تصوير القطع من عدة زوايا وبإضاءة جيدة حتى نتمكن من
                  تقييمها بدقة. فريقنا يرد عليك خلال 5 إلى 10 دقائق بعرض سعر
                  مبدئي. هذا أسرع من أغلب الشركات في السوق التي تحتاج نصف ساعة
                  أو أكثر فقط للرد عليك.
                </p>
              ...
              <div className="relative rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm">
                ...
                <p className="text-sm leading-relaxed text-white/80">
                  ...
                  نحسب القيمة المتبقية الفعلية لاثاثك ونقدم لك عرضاً يعكس هذه
                  القيمة.
                </p>
              </div>
              ...
              <div className="relative rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm">
                ...
                <p className="mb-3 text-sm leading-relaxed text-white/80">
                  ...
                  يتولى فك اثاث وتحميله ونقله بالكامل — مجاناً.
                </p>
                <p className="text-sm leading-relaxed text-white/80">
        ...
        <section className="mx-auto max-w-5xl px-4 py-14 sm:px-6 lg:px-8">
          ...
          <p className="mx-auto mb-8 max-w-3xl text-center leading-relaxed">
            من أكثر الأسئلة التي يسألها الناس: &quot;كم يساوي اثاثي
        ...
        <div className="max-w-3xl mx-auto mb-10 flex item-center justify-center">
          <Button whatsapp size={"lg"} variant={"secondary"}>
            تواصل معنا عبر واتساب وأرسل صور اثاثك
          </Button>
        </div>
        ...
        <section className="mx-auto max-w-4xl px-4 py-14 sm:px-6 lg:px-8">
          ...
          <div className="rounded-2xl border border-[#f5d7cc]/60 bg-[#f5d7cc]/10 p-8">
            <p className="mb-4 leading-relaxed">
              عندما تبيع اثاثك المستعمل لنا بدلاً من رميه أو تركه في الشارع، أنت
              تساهم في شيء أكبر من مجرد صفقة مالية. نحن نعمل بنموذج الاقتصاد
              الدائري: نشتري اثاث المستعمل، نعيد تأهيله وتنظيفه وإصلاحه، ونبيعه
              لأشخاص يحتاجونه فعلاً. هذا يعني اثاثاً أقل في المكبّات، ونفايات
              أقل، وضرراً أقل للبيئة.
            </p>
            <p className="leading-relaxed">
              ...
              نفس الوقت. واثاث الذي لم تعد تحتاجه قد يكون هو بالضبط ما تبحث عنه
              عائلة أخرى في رأس الخيمة بميزانية محدودة. بدلاً من شراء اثاث جديد
              بسعر مرتفع، يحصلون على اثاث بحالة جيدة بسعر مناسب.
            </p>
          </div>
        </section>
        ...
        />
        <CTA
          title="تواصل معنا الآن — احصل على أفضل سعر لاثاثك المستعمل في رأس الخيمة"
          desc="سواء كنت تنتقل من رأس الخيمة أو إليها، تجدد بيتك، تصفّي مكتبك، أو ببساطة تريد التخلص من اثاث لم تعد تحتاجه — نحن هنا لنساعدك. 

نشتري اثاثك المستعمل بأفضل سعر ممكن ونوفر عليك كل التعب. تواصل معنا الآن واحصل على أفضل سعر اثاث المستعمل الخاص بك.
