    ...
    <>
      ...
      <main className="overflow-hidden text-[#694c4c]">
        <LocHeroSection
          ...
          desc=" إذا كنت تبحث عن شراء اثاث مستعمل رأس الخيمة بسعر عادل وبدون تعقيدات، فأنت في المكان الصحيح. نحن في شركة شراء اثاث المستعمل نشتري جميع أنواع الأثاث والأجهزة المستعملة من المنازل والشقق والفلل والمكاتب في كل مناطق رأس الخيمة — من قرية الحمراء وجزيرة المرجان إلى ميناء العرب والضيت وغيرها."
        />
        ...
        <section className="mx-auto max-w-4xl px-4 py-14 sm:px-6 lg:px-8">
          <p className="mb-5 leading-relaxed">
            ...
            خدماتنا في جميع أنحاء الدولة. نعرف قيمة أثاثك الحقيقية ونقدم لك أفضل
        ...
        <section className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
          ...
          <p className="mx-auto mb-12 max-w-3xl text-center leading-relaxed">
            ...
            نوع من الأثاث ولا نشترط أن يكون بحالة ممتازة. هذه أبرز الفئات التي
            نتعامل معها يومياً:
          </p>
            ...
            <div className="grid gap-8 md:grid-cols-3">
              ...
              <div className="relative rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm">
                ...
                <p className="mb-3 text-sm leading-relaxed text-white/80">
                  أرسل لنا صوراً للأثاث الخاصة بك الذي تريد بيعه عبر واتساب.
        ...
        <CTA
          ...
          desc="سواء كنت تنتقل من رأس الخيمة أو إليها، تجدد بيتك، تصفّي مكتبك، أو ببساطة تريد التخلص من أثاث لم تعد تحتاجه — نحن هنا لنساعدك. 
