    ...
    <>
      ...
      <main className="overflow-hidden">
        <LocHeroSection
          ...
          desc="هل عندك أثاث مستعمل في الشارقة وتبحث عن مشتري يعطيك سعر عادل بدون ما تتعب؟ نحن في شركة شراء اثاث مستعمل نوفر لك أسهل طريقة لبيع أثاثك المستعمل في الشارقة."
          img={{
            src: imgSrc,
            alt: "شراء اثاث مستعمل الشارقة",
          }}
        ...
        <div className="mt-16 max-w-6xl mx-auto md:px-0 px-4">
          <div className="md:text-2xl text-lg text-secondary md:px-16 leading-relaxed">
            <p className="md:inline">
              ...
              الشارقة ودبي والإمارات بخبرة تتجاوز 10 سنوات في سوق الأثاث
              المستعمل.
            </p>
            <p className="md:inline">
              شراء اثاث مستعمل الشارقة ليس مجرد خدمة نقدمها. هو شغلنا اليومي
              اللي نفهم فيه أكثر من أي حد ثاني.
            </p>
          </div>
        </div>
        <section className="mt-36 max-w-6xl mx-auto md:px-0 px-4 grid md:grid-cols-2 grid-cols-1 gap-16">
          <div className="md:order-2 order-1">
            <p className="md:text-lg mt-5 text-muted-foreground">
              نشتري كل أنواع الأثاث المنزلي والمكتبي والأجهزة الكهربائية. ونقيّم
              كل قطعة بشفافية كاملة بناءً على حالتها الفعلية وقيمتها في السوق.
            </p>
            <p className="md:text-lg mt-5 text-muted-foreground">
            ...
            <p className="md:text-lg mt-5 text-muted-foreground">
              تواصل معنا عبر واتساب أو الهاتف، واحصل على رد خلال 5 إلى 10 دقائق.
              نرسل لك فريقنا للمعاينة، ونحدد السعر أمامك، وندفع لك فوراً.
            </p>
            <p className="md:text-lg mt-5 text-muted-foreground">
              نقداً أو تحويل بنكي، كما تحب. وطبعاً، خدمة الفك والنقل علينا
              بالكامل.
            </p>
        ...
        <section className="flex mt-32 items-center justify-center">
          <div className="w-full max-w-6xl md:px-6 px-3 py-10">
            ...
            <p className="mt-5 text-lg text-muted-foreground sm:text-xl">
              في الشارقة، تلاقي عشرات الأشخاص اللي يشترون أثاث مستعمل. بعضهم
              تجار شوارع يجون بيتك ويحاولون ياخذون كل شي بأقل سعر ممكن. وبعضهم
              صفحات على الإنترنت ما تعرف مين وراها.
            </p>
            <p className="mt-2 text-lg text-muted-foreground sm:text-xl">
              الفرق بيننا وبين هؤلاء واضح وبسيط:
            </p>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-16 max-w-3xl mx-auto">
              ...
              <p className="text-lg text-slate-600 leading-relaxed max-w-4xl mx-auto">
                الاثاث المستعمل الشارقة متنوع جداً. من الشقق الصغيرة في النهدة
                إلى الفيلات الفاخرة في المجاز، نشتري كل شي.
              </p>
              <p className="text-lg text-slate-600 leading-relaxed max-w-4xl mx-auto">
                ما نقتصر على نوع معين أو ماركة معينة. إذا عندك أثاث في حالة
                مقبولة وصالح للاستعمال، نشتريه.
              </p>
            </div>
        ...
        <SellProcessSection
          ...
          description="بيع اثاث مستعمل الشارقة معنا عملية بسيطة ومباشرة. ما في تعقيدات ولا خطوات كثيرة. خمس خطوات وينتهي كل شي:"
          details={[
            {
