...
export const metadata = MetadataTemplate({
  data: {
    meta: {
      ...
      desc: "شراء اثاث مستعمل الشارقة بأفضل الأسعار. نشتري جميع أنواع اثاث والأجهزة المنزلية من شقق وفيلات ومكاتب. تقييم احترافي، دفع فوري نقدي، واستلام مجاني من جميع مناطق الشارقة. اتصل الآن!",
    },
    image: {
...
const breadcrumbSchema = generateBreadcrumbSchema([
  { name: "شراء اثاث مستعمل الشارقة", path: "/شراء-اثاث-مستعمل-الشارقة" },
]);
    ...
    <>
      ...
      <main className="overflow-hidden">
        <LocHeroSection
          ...
          desc="هل عندك اثاث مستعمل في الشارقة وتبحث عن مشتري اثاث مستعمل  يعطيك سعر عادل بدون ما تتعب؟ نحن في شركة شراء اثاث مستعمل نوفر لك أسهل طريقة لبيع اثاثك المستعمل في الشارقة، حيث أن عملية البيع  لدينا تتميز بالسرعة والشفافية المطلقة."
          img={{
            src: imgSrc,
            alt: "شراء اثاث مستعمل الشارقة",
          }}
        ...
        <div className="mt-16 max-w-6xl mx-auto md:px-0 px-4">
          <div className="md:text-2xl text-lg text-secondary md:px-16 leading-relaxed">
            <p className="md:inline">
              ...
              سنوات في سوق اثاث المستعمل.
            </p>
            <p className="md:inline">
              شراء اثاث مستعمل الشارقة ليس مجرد خدمة نقدمها، بل هو تخصصنا. نحن
              نقدم حلولاً ذكية لكل من يرغب في التخلص من اثاثه القديم والحصول على
              سيولة فورية.
            </p>
          </div>
        </div>
        <section className="mt-36 max-w-6xl mx-auto md:px-0 px-4 grid md:grid-cols-2 grid-cols-1 gap-16">
          <div className="md:order-2 order-1">
            <p className="md:text-lg mt-5 text-muted-foreground">
              نشتري جميع أنواع اثاث المستعمل بما في ذلك اثاث المنزلي والمكتبي
            ...
            <p className="md:text-lg mt-5 text-muted-foreground">
              نقداً أو تحويل بنكي، كما تحب. وطبعاً، خدمة الفك والنقل لجميع اثاث
              الخاص بك علينا بالكامل.
            </p>

            <Button whatsapp size={"lg"} className="mt-5">
              أرسل صور اثاثك عبر الواتساب الآن{" "}
            </Button>
          </div>
          ...
          <div className="w-full max-w-6xl md:px-6 px-3 py-10">
            ...
            <div className="mx-auto mt-12 grid w-full gap-x-6 gap-y-8 md:grid-cols-2 lg:grid-cols-3">
              {[
                {
                  title: "خبرة حقيقية:",
                  desc: "نشتغل في سوق اثاث المستعمل في الشارقة من أكثر من 10 سنوات. نعرف قيمة كل قطعة، ونعرف الفرق بين اثاث اللي يستاهل استثمار فيه واثاث اللي ما يستاهل. هالخبرة تنعكس مباشرة على السعر اللي نعطيك إياه.",
                  icon: (
                    <>
                ...
                },
                {
                  ...
                  desc: "سواء عندك اثاث من IKEA أو Danube أو Home Centre أو Pan Emirates أو Royal Furniture، نشتريه. نعرف القيمة السوقية لكل علامة تجارية ونعطيك سعر يعكسها.",
                  icon: (
                    <>
                ...
                },
                {
                  ...
                  desc: "أرسل لنا صور اثاثك على واتساب واحصل على رد خلال 5 إلى 10 دقائق. مو ساعات ومو أيام. وبعد الاتفاق، فريقنا يوصلك في نفس اليوم في أغلب الحالات.",
                  icon: (
                    <>
              ...
              {[
                {
                  ...
                  description: (
                    <>
                      <p>
                        نشتري جميع قطع اثاث المنزلي. غرف النوم الكاملة بكل
                        مكوناتها: السرير والدولاب والتسريحة والكمودينو.
                      </p>
                      <p>
                        أطقم الكنب والمجالس العربية بكل أنواعها. طاولات الطعام
                        مع الكراسي. الخزائن والأرفف ووحدات التلفزيون. وحتى اثاث
                        غرف الأطفال واثاث الحدائق والشرفات.
                      </p>
                      <p>
                ...
                },
                {
                  ...
                  description: (
                    <>
                      <p>الشركات والمكاتب في الشارقة تجدد اثاثها بشكل دوري.</p>
                      <p>
                ...
                },
                {
                  ...
                  description: (
                    <>
                      <p>
                        بالإضافة للاثاث، نشتري الأجهزة المنزلية المستعملة:
                ...
                },
                {
                  ...
                  description: (
                    <>
                      <p>
                        لو أنت صاحب فندق أو شركة وتبي تجدد اثاثك بالكامل، نقدر
                      ...
                      <p>
                        هذا يشمل الأسرّة الفندقية، كراسي الاستقبال، اثاث
        ...
        <SellProcessSection
          ...
          description="يمكن أن يكون بيع اثاث المستعمل عملية مرهقة إذا تعاملت مع تجار غير محترفين. لكن معنا، الأمر بسيط؛ تبدأ الخطوة الأولى بإرسال صور اثاث الخاص بك عبر الواتساب للحصول على تقييم فوري. بعد الاتفاق، يتولى فريقنا كافة مهام الفك والتحميل دون أي تكاليف إضافية عليك."
          details={[
            {
              ...
              desc: (
                <>
                  <p>
                    اتصل بنا أو أرسل صور اثاثك على واتساب. أخبرنا عن نوع اثاث
              ...
              desc: (
                <>
                  <p>
                    ...
                    لسعر اثاث. هذا التقييم مبني على خبرتنا في السوق وحالة القطع
                    من الصور.
                  </p>
                </>
              ),
            },
            {
              ...
              desc: (
                <>
                  <p>
                    لو وافقت على التقييم الأولي، نرسل فريقنا لمعاينة اثاث في
            ...
            },
            {
              ...
              desc: (
                <>
                  <p>
                    بعد الاتفاق على السعر، فريقنا يفك اثاث ويغلفه وينقله بأمان.
                    نحمي ممتلكاتك خلال النقل: المصاعد والممرات والأبواب. هذي
                    الخدمة مجانية بالكامل لكل بائع.
                  </p>
                </>
              ),
            },
            {
              ...
              desc: (
                <>
                  <p>
                    لحظة ما نحمّل اثاث، تستلم فلوسك. نقد في يدك، أو تحويل بنكي
        ...
        <section className="max-w-4xl mt-16 mx-auto md:px-0 px-4">
          ...
          <p className="mt-10 text-muted-foreground max-w-3xl">
            سوق الشارقة للاثاث المستعمل من أنشط أسواق اثاث في الإمارات. المنطقة
            الرئيسية تتركز في شارع الاستقلال وما حوله في أبو شغارة والقاسمية.
          </p>
          <p className="mt-2 text-muted-foreground">
            هناك تلاقي عشرات المحلات والمعارض اللي تبيع وتشتري اثاث مستعمل
          ...
          <div className="mt-5">
            <div className="max-w-3xl">
              ...
              <p className="text-muted-foreground mt-5">
                ونصيحتنا لأي شخص يبي يتعامل في سوق اثاث المستعمل: قارن الأسعار
        ...
        <section className="max-w-4xl mt-36 mx-auto md:px-0 px-4">
          ...
          <p className="text-muted-foreground mt-5">
            ...
            هل اثاث نظيف؟ هل فيه حشرات؟ هل هو آمن للاستخدام؟ هذي مخاوف مشروعة،
          ...
          <div className="grid md:grid-cols-2 gird-cols-1 gap-10 md:mt-16 mt-10">
            <div>
              ...
              <p className="text-muted-foreground mt-5">
                كل قطعة اثاث نشتريها تمر بفحص كامل. نتحقق من الهيكل والخامات
            ...
            <div>
              ...
              <p className="text-muted-foreground mt-5">
                كل اثاث المنجد، يعني الكنب والمجالس والأسرّة المنجدة، يمر
        ...
        <section className="max-w-4xl mt-36 mx-auto md:px-0 px-4">
          ...
          <div className="grid md:grid-cols-2 gird-cols-1 gap-10 md:mt-16 mt-10">
            <div>
              ...
              <p className="text-muted-foreground mt-5">
                لو تبيع لنا اثاثك، فريقنا يفك كل شي باحترافية كاملة بدون أي
                تكلفة عليك.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-muted-foreground mt-5">
                عندنا سيارات مجهزة خصيصاً لنقل اثاث. مو سيارات بيك أب عادية.
                سيارات مغلقة تحمي اثاثك من الشمس والغبار والصدمات.
              </p>
            </div>
            <div>
              <h3 className="text-xl text-secondary  font-semibold">
              ...
              <p className="text-muted-foreground mt-5">
                لو اشتريت اثاث منا، نوفر لك خدمة توصيل سريعة بأسعار مخفضة من
                خلال شبكة شركائنا.
              </p>
            </div>
          </div>
        ...
        <section className="max-w-4xl mt-32 mx-auto md:px-0 px-4">
          <h2 className="md:text-4xl text-3xl text-secondary font-bold">
            ...
            <Link href={"/"}>لماذا شراء اثاث المستعمل</Link> مهم؟
          </h2>
          <p className="mt-10 text-muted-foreground max-w-3xl">
            كثير من الناس يشوفون <Link href="/">شراء وبيع اثاث المستعمل</Link>{" "}
            كمجرد وسيلة لتوفير المال. وهو فعلاً كذلك. لكن الموضوع أكبر من كذا.
          </p>
          <p className="mt-2 text-muted-foreground">
            كل سنة، آلاف الأطنان من اثاث في الإمارات ينتهي بها المطاف في مكبات
            النفايات. اثاث في حالة ممتازة يرمى لأن صاحبه ما لقى مشتري، أو لأن
            النقل صعب، أو ببساطة لأنه ما يبي يتعب نفسه.
          </p>
          <div className="mt-5">
            <div className="max-w-3xl">
              <p className="text-muted-foreground mt-5">
                نحن نؤمن بالاقتصاد الدائري. كل قطعة اثاث نشتريها ونعيد بيعها هي
                قطعة أقل في المكب. وهذا يتماشى مع أهداف الاستدامة في دولة
                الإمارات. أنت لما تبيع اثاثك لنا، أنت ما بس تحصل على فلوس. أنت
                تساهم في تقليل النفايات وحماية البيئة.
              </p>
              <p className="text-muted-foreground mt-5">
                ولما تشتري اثاث مستعمل بدل الجديد، أنت توفر فلوسك وتحصل على قطع
                بجودة عالية بسعر أقل بكثير. واثاث المستعمل اللي نبيعه مفحوص
        ...
        />
        <CTA
          title="تواصل معنا الآن - احصل على تقييم مجاني لاثاثك في الشارقة"
          desc="لو عندك اثاث مستعمل في الشارقة أو أي إمارة ثانية وتبي تبيعه بسعر عادل وبدون تعب، نحن جاهزين. كل اللي عليك تسويه هو إنك تتواصل معنا. اتصل بنا أو أرسل صور اثاثك عبر واتساب. نرد عليك خلال دقائق ونعطيك تقييم أولي مجاني بدون أي التزام. لو عجبك السعر، نكمل. لو ما عجبك، ما في مشكلة."
        />
      </main>
    </>
  );
