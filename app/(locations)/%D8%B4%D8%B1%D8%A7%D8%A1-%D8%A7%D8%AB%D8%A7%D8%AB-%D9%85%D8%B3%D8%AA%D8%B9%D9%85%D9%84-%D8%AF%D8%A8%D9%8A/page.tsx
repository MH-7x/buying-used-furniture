...
export const metadata = MetadataTemplate({
  data: {
    meta: {
      ...
      desc: "شراء اثاث مستعمل دبي بأفضل الأسعار! نصل خلال 5-10 دقائق. نشتري الأثاث والأجهزة المنزلية في دبي مارينا والخليج التجاري وجميرا. تقييم احترافي. اتصل الآن!",
    },
    image: {
    ...
    <>
      ...
      <main className=" overflow-hidden">
        ...
        <div className="mt-16 max-w-6xl mx-auto md:px-0 px-4">
          ...
          <div className="md:text-xl text-lg text-secondary mt-16 md:px-16 leading-relaxed">
            <p className="md:inline">
              نشتري اثاث المستعمل في دبي بأسعار واقعية ونقدم لك المبلغ في نفس
              اليوم، مع خدمة تفكيك ونقل مجانية. نحن نسهّل عليك عملية البيع
        ...
        <section className="mt-36 max-w-6xl mx-auto md:px-0 px-4 grid md:grid-cols-2 grid-cols-1 gap-16">
          ...
          "
            ...
            <p className="mt-5 text-muted-foreground">
              ...
              الإعلانات الأخرى. المشكلة أن العملية تأخذ وقتاً طويلاً ومجهوداً
              كبيراً:
            </p>
...
"
        ...
        <section className="max-w-4xl mt-36 mx-auto md:px-0 px-4">
          ...
          <p className="text-muted-foreground mt-5">
            نعمل في كل مناطق دبي والإمارات العربية المتحدة. مقرنا الرئيسي في
            الشارقة، لكن معظم عملائنا في دبي ونوصل لأي منطقة.
          </p>
