...
export const metadata = MetadataTemplate({
  data: {
    meta: {
      ...
      desc: "شراء اثاث مستعمل عجمان - نشتري جميع أنواع الأثاث والأجهزة بأعلى سعر مع دفع فوري نقداً. تقييم خلال 5 دقائق وخدمة نقل مجانية. تواصل معنا اليوم!",
    },
      ...
      <main className=" text-[#694c4c]">
        ...
        <section className="mx-auto max-w-5xl px-4 py-14 sm:py-20 space-y-6">
          ...
          <p className="text-base sm:text-lg leading-relaxed">
            ...
            السوق. أرسل لنا صور أثاثك عبر الواتساب واحصل على عرض سعر خلال 5 إلى
        ...
        <section className="bg-[#f5d7cc]/20 py-14 sm:py-20">
          <div className="mx-auto max-w-5xl px-4">
            ...
            <p className="text-base sm:text-lg leading-relaxed">
              هالطريقة تضمن لك سعر عادل يعكس القيمة الحقيقية لأثاثك. تواصل معنا
