...
export const metadata = MetadataTemplate({
  data: {
    meta: {
      ...
      desc: "شراء اثاث مستعمل عجمان - نشتري جميع أنواع اثاث والأجهزة بأعلى سعر مع دفع فوري نقداً. تقييم خلال 5 دقائق وخدمة نقل مجانية. تواصل معنا اليوم!",
    },
...
const evaluationFactors = [
  {
    factor: "الماركة",
    effect:
      "اثاث الماركات المعروفة يحتفظ بقيمة أعلى في السوق — ايكيا، هوم سنتر، دانوب وغيرها",
  },
  {
    factor: "الحالة",
...
const steps = [
  {
    num: 1,
    title: "تواصل معنا",
    desc: "أرسل لنا صور اثاث عبر الواتساب أو اتصل بنا. صور عادية من الموبايل تكفي. اكتب لنا نوع القطعة وحالتها بشكل مختصر.",
  },
  {
    num: 2,
    title: "تقييم فوري",
...
const areas = [
  {
    ...
    desc: "الجرف من أنشط المناطق السكنية في عجمان وتقع على حدود الشارقة. فيها حركة سكانية مستمرة — عائلات تنتقل وأخرى تجدد اثاثها. المنطقة قريبة من مقرّنا في أبو شغارة، يعني وقت الوصول لها من أسرع الأوقات عندنا.",
  },
  {
  ...
  },
  {
    ...
    desc: "النعيمية فيها كثافة سكانية عالية وتجمع بين السكني والتجاري. لو عندك شقة أو مكتب في النعيمية وتبي تبيع اثاثك المستعمل، تواصل معنا وفريقنا يوصلك في نفس اليوم في أغلب الحالات.",
  },
  {
    title: "اثاث مستعمل المويهات والروضة عجمان",
    desc: "المويهات والروضة من المناطق اللي تنمو بسرعة. فيها فلل جديدة ومجمعات سكنية، وكثير من العائلات اللي تنتقل لبيوت أكبر أو أصغر تحتاج تبيع اثاثها القديم. نستقبل طلبات كثيرة من هالمنطقتين.",
  },
  {
    title: "اثاث مستعمل كورنيش عجمان وداون تاون",
    desc: "أبراج الكورنيش ومنطقة داون تاون فيها شقق مفروشة كثيرة وحركة إيجارية نشطة. نتعامل مع ملّاك العقارات والمستأجرين اللي ينتقلون ويحتاجون يبيعون اثاثهم بسرعة.",
  },
  {
...
const tips = [
  ...
  },
  {
    ...
    desc: "قبل رمضان يزيد الطلب على المجالس وطاولات الطعام. وبداية السنة الدراسية يزيد الطلب على اثاث الشقق. التوقيت يفرق في السعر.",
  },
  {
  ...
  },
  {
    ...
    desc: "بعض التجار يعطونك سعر يبان أعلى لكن يخصمون منك تكاليف النقل والفك. عندنا الفك والنقل مجاني، والسعر اللي نعطيك إياه هو اللي تستلمه — وبهالطريقة تضمن أفضل سعر اثاث المستعمل بدون تكاليف مخفية.",
  },
];
...
const furnitureTypes = [
  {
    ...
    desc: "تنتقل من عجمان وتبي تبيع كل اثاث بيتك مرة وحدة؟ هالخدمة كثير من عملاءنا يستخدمونها. نرسل فريق لتقييم جميع القطع — اثاث الصالة، غرف النوم، المطبخ، الأجهزة — ونعطيك عرض شامل لكل شي. بعد الموافقة، نسوي كل شي من الفك للنقل وتستلم المبلغ فوراً.",
    extra:
  ...
  },
  {
    ...
    desc: "لأصحاب الشركات والمكاتب في عجمان: نشتري المكاتب، الكراسي المكتبية، الأرفف، طاولات الاجتماعات، وخزائن الملفات. ونقدر نشتري اثاث مكتب كامل في زيارة وحدة بدون ما نعطّلك عن شغلك.",
  },
  {
    id: "appliances",
    ...
    desc: "بالإضافة للاثاث، نشتري الأجهزة الكهربائية المنزلية: ثلاجات، غسالات، مكيفات سبليت، مجففات، أفران، شاشات تلفزيون. الشرط إنها تكون شغّالة أو قابلة للإصلاح البسيط.",
  },
  {
    id: "bedroom",
    ...
    href: "/شراء-الأثاث-المنزلي",
    desc: "غرف النوم من أكثر القطع اللي نشتريها. نأخذ مجموعات غرف النوم الكاملة — السرير، الدولاب، وخزائن الملابس، الكومودينو، التسريحة — أو قطع منفصلة. جميع المقاسات مقبولة: سنجل، كوين، كينج. ونتكفّل بالفك والتغليف والنقل — ما تحتاج تسوي شي.",
  },
];
...
const breadcrumbSchema = generateBreadcrumbSchema([
  { name: "شراء اثاث مستعمل عجمان", path: "/شراء-اثاث-مستعمل-عجمان" },
]);
      ...
      <main className=" text-[#694c4c]">
        ...
        <LocHeroSection
          ...
          desc=" هل عندك اثاث مستعمل في عجمان وتبحث عن مشترٍ يعطيك سعر عادل بدون لف
            ...
            المفاوضة العشوائية.  نشتري جميع أنواع الاثاث المستعمل في عجمان — غرف نوم، كنب، مجالس، أجهزة كهربائية، اثاث مكتبي — وندفع لك نقداً في نفس اليوم. لو تبحث عن مشتري اثاث مستعمل في عجمان يكون موثوق ويعطيك سعر عادل، فأنت في المكان الصح — نحن نشتري اثاث مستعمل بجميع أنواعه وحالاته.."
        />
        {/* ═══════════ INTRO PARAGRAPHS ═══════════ */}
        <section className="mx-auto max-w-5xl px-4 py-14 sm:py-20 space-y-6">
          ...
          <p className="text-base sm:text-lg leading-relaxed">
            الفرق بيننا وبين غيرنا واضح: نحن نقدم خدمة شراء اثاث المستعمل في
            عجمان بنظام تقييم يأخذ بالاعتبار حالة القطعة، ماركتها، وسعرها في
            السوق. أرسل لنا صور اثاثك عبر الواتساب واحصل على عرض سعر خلال 5 إلى
            10 دقائق — بدون أي التزام.
          </p>
          <p className="text-base sm:text-lg leading-relaxed">
            كثير من الناس يسألون عن محلات اثاث مستعمل في عجمان أو يبحثون عن
            أرقام تجار يشترون الاثاث الخاص بك. لو كنت واحد منهم، فنحن هنا
            لخدمتك. الفرق إننا مو مجرد محل صغير — نحن شركة متكاملة عندها فريق
            تقييم، فريق نقل، وورشة صيانة وتجديد. يعني سواء كنت تبي تبيع اثاث
            مستعمل في عجمان أو تشتري قطعة بحالة ممتازة، عندنا كل شي تحت سقف
            واحد.
          </p>
        </section>
        ...
        <section className="bg-[#f5d7cc]/20 py-14 sm:py-20">
          <div className="mx-auto max-w-5xl px-4">
            ...
            <div className="space-y-5 text-base sm:text-lg leading-relaxed">
              <p>
                لو سألت أي شخص جرّب بيع اثاث المستعمل في الإمارات العربية
                المتحدة، غالباً راح يقولك إنها تجربة متعبة. تتصل بأكثر من تاجر،
                كل واحد يعطيك سعر مختلف، وبعضهم يجي لبيتك ويبدأ يقلل من قيمة
                أغراضك عشان يحصل صفقة أرخص.
              </p>
              <p>
                هذا بالضبط الشي اللي نرفضه. نحن في شركة شراء اثاث مستعمل لا
                نشتغل مثل تجار الشارع. عندنا نظام واضح ومعايير محددة لتقييم كل
                قطعة، وعندنا فريق متخصص يفهم قيمة اثاث.
              </p>
              <p>
        ...
        <section className="mx-auto max-w-5xl px-4 py-14 sm:py-20">
          ...
          <div className="space-y-5 text-base sm:text-lg leading-relaxed">
            <p>
              ...
              — أسعار ايكيا المستعملة، قيمة اثاث دانوب، هوم سنتر، بان إمارتس،
        ...
        <section className="bg-[#f5d7cc]/20 py-14 sm:py-20">
          <div className="mx-auto max-w-5xl px-4">
            <h3 className="text-xl sm:text-2xl font-bold text-[#413332] mb-4">
              تقييم عادل وشفاف لاثاثك المستعمل
            </h3>
            <p className="text-base sm:text-lg leading-relaxed mb-8">
              كيف نحدد سعر اثاثك؟ ما نخمّن وما نرمي أرقام عشوائية. نعتمد على
              أربعة عوامل أساسية:
            </p>
            ...
            <p className="text-base sm:text-lg leading-relaxed">
              هالطريقة تضمن لك سعر عادل يعكس القيمة الحقيقية لاثاثك. تواصل معنا
              واحصل على أفضل سعر اثاث مستعمل في عجمان بدون أي التزام — وإذا ما
              ناسبك العرض، القرار يرجعلك.
            </p>
          </div>
        </section>
        ...
        <section className="bg-[#f5d7cc]/20 py-14 sm:py-20">
          <div className="mx-auto max-w-6xl px-4">
            ...
            <p className="text-center text-base sm:text-lg leading-relaxed mb-10 max-w-3xl mx-auto">
              نشتري جميع أنواع اثاث المستعمل تقريباً — سواء كانت قطعة وحدة أو
              اثاث بيت كامل. لا نقتصر على نوع معين. هذي التفاصيل:
            </p>
        ...
        <section className="mx-auto max-w-5xl px-4 py-14 sm:py-20">
          ...
          <div className="space-y-5 text-base sm:text-lg leading-relaxed">
            <p>
              لو كنت تبحث عن اثاث لبيتك أو مكتبك الجديد في عجمان، فإن التوجه
              لشراء اثاث مستعمل يوفّر عليك مبالغ كبيرة. طقم غرفة نوم جديد ممكن
              يكلّفك 8,000 إلى 15,000 درهم — نفس الطقم مستعمل بحالة ممتازة تحصله
              عندنا بـ 2,000 إلى 5,000 درهم. الفرق واضح.
            </p>
            <p>
            ...
            <p>
              ...
              ناس تنتقل وتبيع اثاث ممتاز بأسعار مناسبة جداً. نحن ندور نوفر هاثاث
              للمشترين بعد ما نفحصه ونعقّمه ونتأكد من جودته.
            </p>
          </div>
        </section>
        ...
        <section className="bg-[#f5d7cc]/20 py-14 sm:py-20">
          <div className="mx-auto max-w-5xl px-4">
            <h2 className="text-2xl sm:text-3xl font-bold text-[#413332] mb-4 text-center">
              نصائح عملية للحصول على أفضل سعر لاثاثك المستعمل في عجمان
            </h2>
            <p className="text-center text-base sm:text-lg leading-relaxed mb-10 max-w-3xl mx-auto">
        ...
        <CTA desc="أرسل صور اثاثك عبر الواتساب الآن واحصل على عرض سعر خلال دقائق. حوّل اثاثك المستعمل إلى نقد اليوم." />
      </main>
    </>
  );
}
