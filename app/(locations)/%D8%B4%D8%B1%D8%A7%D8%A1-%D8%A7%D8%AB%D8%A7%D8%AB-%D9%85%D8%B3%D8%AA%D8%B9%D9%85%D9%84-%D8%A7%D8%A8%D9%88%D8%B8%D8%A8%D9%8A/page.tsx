...
const breadcrumbSchema = generateBreadcrumbSchema([
  { name: "شراء اثاث مستعمل ابوظبي", path: "/شراء-اثاث-مستعمل-ابوظبي" },
]);
  ...
  return (
    <>
      ...
      <main className=" overflow-hidden">
        <LocHeroSection
          title="شراء اثاث مستعمل ابوظبي – دفع نقدي فوري "
          desc="هل تبحث عن شراء اثاث مستعمل ابوظبي بسعر عادل ومعاملة واضحة من البداية؟ في شركة شراء اثاث مستعمل نشتري جميع أنواع اثاث المنزلي والمكتبي والأجهزة الكهربائية في كل مناطق أبوظبي و الإمارات العربية المتحدة. "
          img={{
            src: imgSrc,
            alt: "شراء اثاث مستعمل ابوظبي",
          }}
        ...
        <div className="mt-16 max-w-6xl mx-auto md:px-0 px-4">
          <div className="md:text-xl text-lg text-secondary md:px-16 leading-relaxed">
            <p className="md:inline">
              لا نحتاج منك غير صور عبر الواتساب أو التواصل معنا عبر الإنترنت،
              ونرد عليك خلال 5 إلى 10 دقائق بعرض سعر واضح.
            </p>
            <p className="md:inline">
            ...
            <p className="md:inline">
              نوصلك بفريقنا، نفك اثاث، ننقله بأمان، وندفع لك نقداً في نفس
              اللحظة.
            </p>
          </div>
        </div>
        <section className="mt-36 max-w-6xl mx-auto md:px-0 px-4 grid md:grid-cols-2 grid-cols-1 gap-16">
          <div className="md:order-2 order-1">
            ...
            <p className="md:text-lg mt-5 text-muted-foreground">
              ...
              شركة تصفي اثاث مكتبها القديم – نحن نتعامل مع كل الحالات. نشتري
              اثاث مستعمل من الشقق والفلل والمكاتب والفنادق.
            </p>
            <p className="md:text-lg mt-5 text-muted-foreground">
              ونبيع لعائلات وأفراد يبحثون عن اثاث بحالة ممتازة بأسعار تناسب
              ميزانيتهم. خدمة بيع و شراء اثاث مستعمل ابوظبي عندنا مصممة لتكون
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-16 max-w-3xl mx-auto">
              ...
              <p className="text-lg text-slate-600 leading-relaxed max-w-4xl mx-auto">
                نشتري تقريباً كل شيء بشرط أن تكون القطع في حالة جيدة ويمكن إعادة
                بيعها. سواء كنت تصفّي شقة كاملة قبل السفر. أو تبدّل غرفة نوم
                واحدة، أو عندك مكتب كامل تحتاج تفرغه – نحن جاهزين.
              </p>
              <p className="text-lg text-slate-600 leading-relaxed max-w-4xl mx-auto">
              ...
              {[
                ...
                },
                {
                  ...
                  description: (
                    <>
                      <p>
                        نشتري مجموعات غرف النوم الكاملة – السرير والدولاب
                        والتسريحة والكومودينو – أو القطع المنفردة حسب حالتها.
                      </p>
                      <p>
                ...
                {
                  id: 4,
                  title: "شراء اثاث مكتبي مستعمل في ابوظبي",
                  ...
                  description: (
                    <>
                      ...
                      <p>
                        لو شركتك تنتقل لمقر جديد أو تحتاج تصفية اثاث مكتبي
                ...
                {
                  id: 5,
                  title: "شراء اثاث مطابخ وغرف طعام مستعملة",
        ...
        <SellProcessSection
          ...
          description="يمكن أن يكون بيع اثاث المستعمل في ابوظبي سهلاً وسريعاً – ما يحتاج يكون معقد. خدمة بيع وشراء اثاث مستعمل في ابوظبي عندنا مبنية على 3 خطوات بسيطة:"
          details={[
            {
              title: "الخطوة الأولى: أرسل صور اثاثك عبر الواتساب ",
              desc: (
                <>
                  <p>
                    صوّر القطع اللي تبي تبيعها من أكثر من زاوية. لا تحتاج تكون
                    صور احترافية – المهم تكون واضحة. يمكنك أيضاً إرسال فيديو
                    قصير للقطع الكبيرة.
                  </p>
                  <p>
            ...
            },
            {
              ...
              desc: (
                <>
                  ...
                  <p>
                    فريقنا يوصل لموقعك، يعاين اثاث بشكل مباشر، ويعطيك السعر
            ...
            },
            {
              ...
              desc: (
                <>
                  <p>
                    فريقنا يتولى فك اثاث بالكامل وتغليفه ونقله بخدمة النقل الآمن
                    المعتمد اللي تحمي عقارك.
                  </p>
                  <p>
          ...
          <div className="grid md:grid-cols-2 grid-cols-1 gap-x-10 mt-10">
            <div>
              ...
              <p className="text-muted-foreground mt-5">
                ...
                ابوظبي، واثاث فيها غالباً يكون من ماركات عالية الجودة. نحن نفهم
                قيمة هذا اثاث ونقدم أسعار تعكس جودته الحقيقية.
              </p>
              <p className="text-muted-foreground mt-5">
            ...
            <div>
              ...
              <p className="text-muted-foreground mt-5">
                ...
                من السكان هنا عائلات وافدة تنتقل بشكل دوري، وتحتاج تبيع اثاثها
                بسرعة وبسعر عادل.
              </p>
              <p className="text-muted-foreground mt-5">
        ...
        <section className="max-w-4xl mt-36 mx-auto md:px-0 px-4">
          ...
          <div className="grid md:grid-cols-2 gird-cols-1 gap-10 md:mt-16 mt-10">
            ...
            <div>
              ...
              <p className="text-muted-foreground mt-5">
                الطلب على اثاث المستعمل يرتفع قبل رمضان وقبل العيد وفي موسم
        ...
        <section className="max-w-4xl mt-16 mx-auto md:px-0 px-4">
          ...
          <p className="mt-10 text-muted-foreground max-w-3xl">
            شراء وبيع الاثاث المستعمل بدلاً من شراء اثاث جديد مو بس توفير مال –
            هو كمان خطوة عملية نحو الاستدامة. كل قطعة اثاث تُعاد استخدامها بدل
            ما ترمى في المكب هي مساهمة حقيقية في تقليل النفايات.
          </p>
        ...
        <section className="max-w-4xl mt-16 mx-auto md:px-0 px-4">
          ...
          <p className="mt-5 text-muted-foreground">
            ...
            لاحقاً) لمساعدة العائلات في شراء قطع اثاث كبيرة بدون ضغط مالي. هذه
        ...
        <section className="max-w-4xl mt-16 mx-auto md:px-0 px-4">
          ...
          <p className="mt-10 text-muted-foreground max-w-3xl">
            هذه النقطة مهمة جداً ونريد نكون واضحين فيها: كل قطعة اثاث نبيعها
        ...
        <CTA
          ...
          desc="سواء كنت تبي تبيع اثاثك المستعمل في ابوظبي أو تبحث عن قطع اثاث بحالة ممتازة بأسعار معقولة – نحن هنا لمساعدتك. . لا تضيع وقتك في البحث عن مشترين على الإنترنت أو في التفاوض مع تجار ما تعرفهم. يرجى الاتصال بنا في شركة شراء اثاث مستعمل واحصل على تجربة مختلفة تماماً عن اللي اعتدت عليه في سوق اثاث المستعمل."
        />
      </main>
    </>
  );
