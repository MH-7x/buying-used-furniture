  ...
  return (
    <>
      ...
      <main className=" overflow-hidden">
        <LocHeroSection
          title="شراء اثاث مستعمل ابوظبي – دفع نقدي فوري "
          desc="هل تبحث عن شراء اثاث مستعمل ابوظبي بسعر عادل ومعاملة واضحة من البداية؟ في شركة شراء اثاث مستعمل نشتري جميع أنواع الأثاث المنزلي والمكتبي والأجهزة الكهربائية في كل مناطق أبوظبي و الإمارات العربية المتحدة. "
          img={{
            src: imgSrc,
            alt: "شراء اثاث مستعمل ابوظبي",
          }}
        ...
        <section className="mt-36 max-w-6xl mx-auto md:px-0 px-4 grid md:grid-cols-2 grid-cols-1 gap-16">
          <div className="md:order-2 order-1">
            ...
            <p className="md:text-lg mt-5 text-muted-foreground">
              ...
              شركة تصفي أثاث مكتبها القديم – نحن نتعامل مع كل الحالات. نشتري
        ...
        <section className="max-w-4xl mt-16 mx-auto md:px-0 px-4">
          ...
          <p className="mt-10 text-muted-foreground max-w-3xl">
            شراء وبيع الاثاث المستعمل بدلاً من شراء أثاث جديد مو بس توفير مال –
            هو كمان خطوة عملية نحو الاستدامة. كل قطعة أثاث تُعاد استخدامها بدل
        ...
        <CTA
          ...
          desc="سواء كنت تبي تبيع اثاثك المستعمل في ابوظبي أو تبحث عن قطع أثاث بحالة ممتازة بأسعار معقولة – نحن هنا لمساعدتك. . لا تضيع وقتك في البحث عن مشترين على الإنترنت أو في التفاوض مع تجار ما تعرفهم. يرجى الاتصال بنا في شركة شراء اثاث مستعمل واحصل على تجربة مختلفة تماماً عن اللي اعتدت عليه في سوق الأثاث المستعمل."
        />
      </main>
    </>
  );
