...
export const metadata = MetadataTemplate({
  data: {
    meta: {
      ...
      desc: "شراء اثاث مستعمل العين بأعلى الأسعار. نشتري جميع أنواع اثاث والأجهزة الكهربائية المستعملة في العين. تقييم مجاني، دفع فوري نقداً، واستلام خلال ساعة. اتصل الآن!",
    },
    image: {
...
const breadcrumbSchema = generateBreadcrumbSchema([
  { name: "شراء اثاث مستعمل العين", path: "/شراء-اثاث-مستعمل-العين" },
]);
    ...
    <>
      ...
      <main className="overflow-hidden text-[#606060]">
        <LocHeroSection
          ...
          title="شراء اثاث مستعمل العين - نشتري اثاثك بأعلى سعر اليوم"
          desc="

هل تبحث عن مشتري يدفع لك سعر عادل لاثاثك المستعمل في العين؟ إذا كنت ترغب في بيع اثاثك بسرعة وبأعلى سعر، أنت في المكان الصحيح. نحن في شركة شراء اثاث مستعمل متخصصون في شراء اثاث مستعمل العين بأعلى الأسعار الممكنة. ببساطة، أرسل لنا صور اثاث على الواتساب، وخلال دقائق نعطيك سعر واضح بدون مساومة أو تعقيد."
        />
        {/* ── trust bar ── */}
        <div className="mt-16 max-w-6xl mx-auto md:px-0 px-4">
          <div className="md:text-xl text-lg text-secondary md:px-16 leading-relaxed">
            <p className="md:inline">
              نشتري جميع أنواع اثاث المستعمل في العين: غرف نوم، كنب، طاولات
              سفرة، أجهزة كهربائية، وخزائن الملابس، واثاث مكتبي. قم ببيع اثاثك
              اليوم واحصل على أفضل سعر اثاث المستعمل في السوق.
            </p>
            <p className="md:inline">
              . سواء كنت تنتقل لبيت جديد، أو تجدد اثاث شقتك، أو تغادر الإمارات
              نحن الحل الأسرع والأضمن لك.
            </p>
            <p className="md:inline">
              من خبرتنا اللي تزيد عن عشر سنوات في سوق الاثاث المستعمل في
              الإمارات، نعرف بالضبط كم يساوي اثاثك.
            </p>
            <p className="md:inline">
        ...
        <Section>
          ...
          <p className="mb-4 leading-relaxed max-w-4xl">
            لما تقرر تبيع اثاثك المستعمل في العين، عندك ثلاث خيارات: تنزل إعلان
            على الإنترنت وتنتظر أسابيع، أو تتعامل مع تاجر في الشارع يحاول يشتري
            بأقل سعر ممكن، أو تتواصل معنا ونحن نريحك من كل هالتعب. نحن نقدم خدمة
            شراء اثاث المستعمل في العين بطريقة مريحة وسريعة تسهّل عليك عملية
            البيع بالكامل.
          </p>
          <p className="mb-4 leading-relaxed max-w-4xl">
          ...
          <p className="mb-8 leading-relaxed max-w-4xl">
            وأهم شيء: نحن صريحين في التسعير. لما نقيّم قطعة اثاث، نشرح لك ليش
          ...
          <div className="grid gap-8 md:grid-cols-3">
            ...
            <article className="rounded-3xl bg-white p-6">
              <h3 className="mb-3 text-xl font-bold text-[#413332]">
                تقييم عادل وشفاف للاثاث المستعمل
              </h3>
              <p className="mb-3 leading-relaxed">
                كل قطعة اثاث تمر على فحص دقيق قبل ما نحدد سعرها. فريقنا يشوف
            ...
            <article className="rounded-3xl bg-white p-6">
              ...
              <p className="leading-relaxed">
                فريقنا مدرب على التعامل مع اثاث بعناية. الفك والتغليف والنقل يتم
                بطريقة احترافية تحمي اثاثك وتحمي ممتلكاتك. نستخدم نظام الإزالة
                الآمنة اللي يشمل حماية المصاعد والممرات أثناء النقل، لأن الخدش
                أو الضرر في البناية مشكلة حقيقية مع النقل غير المتخصص.
              </p>
            </article>
        ...
        <Section>
          ...
          <p className="mb-10 leading-relaxed max-w-4xl">
            ...
            تبحث عن مشتري لاثاثك أو تبي تشتري قطع بحالة ممتازة، عندنا الحل. وكل
            خدمة مصممة عشان توفر عليك الوقت والجهد والقلق.
          </p>
          ...
          <div className="grid gap-8 sm:grid-cols-2 mt-16">
            ...
            <article className="group overflow-hidden rounded-2xl border border-[#f5d7cc] transition hover:shadow-lg">
              <PlaceholderImage
                alt="شراء اثاث المنزلي المستعمل في العين"
                aspect="aspect-4/3"
              ...
              <div className="p-6">
                <Link href="/شراء-الأثاث-المنزلي">
                  <h3 className="mb-3 text-xl font-bold text-[#413332]">
                    شراء اثاث المنزلي المستعمل
                  </h3>
                </Link>
                <p className="mb-3 leading-relaxed">
                  نشتري كل أنواع اثاث المنزلي المستعمل في العين: كنب ومجالس
                  بجميع الأحجام، غرف نوم كاملة مع السرير والدولاب والتسريحة،
                  طاولات سفرة مع الكراسي، خزائن ودواليب تخزين وخزائن الملابس،
                  وأي قطعة اثاث منزلي ثانية. إذا كنت ترغب في بيع اثاثك المستعمل،
                  تواصل معنا وأرسل صور واضحة.
                </p>
                <p className="leading-relaxed">
            ...
            <article className="group overflow-hidden rounded-2xl border border-[#f5d7cc] transition hover:shadow-lg">
              ...
              <div className="p-6">
                ...
                <p className="mb-3 leading-relaxed">
                  بجانب اثاث، نشتري جميع الأجهزة الكهربائية المستعملة في العين.
                  ثلاجات، غسالات، مكيفات سبليت وشباك، تلفزيونات، أفران، سخانات
                  مياه، وغسالات صحون. كل جهاز يتم فحصه والتأكد من عمله قبل تحديد
                  السعر.
                </p>
                <p className="leading-relaxed">
            ...
            <article className="group overflow-hidden rounded-2xl border border-[#f5d7cc] transition hover:shadow-lg">
              <PlaceholderImage
                alt="شراء اثاث المكاتب المستعمل في العين"
                aspect="aspect-4/3"
              ...
              <div className="p-6">
                <Link href="/شراء-الاثاث-المكتبي-المستعمل">
                  <h3 className="mb-3 text-xl font-bold text-[#413332]">
                    شراء اثاث المكاتب المستعمل في العين
                  </h3>
                </Link>
            ...
            <article className="group overflow-hidden rounded-2xl border border-[#f5d7cc] transition hover:shadow-lg">
              ...
              <div className="p-6">
                ...
                <p className="leading-relaxed">
                  كل قطعة اثاث نبيعها تمر على فحص كامل وتنظيف احترافي. الكنب
        ...
        <Section>
          ...
          <p className="mb-8 leading-relaxed max-w-4xl">
            ...
            منطقة تسكن، نوصل لك ونشتري اثاثك ونفكه وننقله على حسابنا. هنا قائمة
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              {
                name: "منطقة المقام",
                desc: "بالقرب من جامعة الإمارات. كثير من الطلاب والعائلات يحتاجون يبيعون اثاثهم عند الانتقال.",
              },
              {
                name: "منطقة الياهر",
              ...
              {
                name: "منطقة فلج هزاع",
                desc: "من المناطق اللي نتلقى منها طلبات كثيرة لشراء اثاث المستعمل والأجهزة.",
              },
              {
                name: "منطقة الخبيصي",
        ...
        <Section bg="bg-gradient-to-b from-[#f5d7cc]/20 to-white">
          <h2 className="mb-4 text-center text-2xl font-bold text-[#413332] md:text-3xl">
            كيف تبيع اثاثك المستعمل في العين في 3 خطوات فقط؟
          </h2>
            ...
            {[
              {
                step: "1",
                title: "تواصل معنا",
                text: "أرسل لنا صور اثاث اللي تبي تبيعه على الواتساب أو من خلال نموذج التواصل في الموقع. حاول تصور القطع في إضاءة واضحة ومن أكثر من زاوية. خلال 5 إلى 10 دقائق، نرد عليك بسعر مبدئي.",
              },
              {
                step: "2",
                title: "تقييم مجاني ومعاينة",
                text: "إذا وافقت على السعر المبدئي، فريقنا يجي لموقعك في العين لمعاينة اثاث شخصياً. المعاينة مجانية وبدون أي التزام. لو ما ناسبك السعر النهائي، ما في مشكلة ولا أي تكلفة عليك.",
              },
              {
                step: "3",
                title: "دفع فوري واستلام",
                text: "بعد الاتفاق على السعر، ندفع لك فوراً: نقداً أو تحويل بنكي أو شيك حسب ما يناسبك. وفريقنا يتولى فك اثاث وتغليفه ونقله بالكامل. أنت ما تحتاج تحرك شيء.",
              },
            ].map((item) => (
        ...
        <Section>
          <div className="grid items-start gap-10 md:grid-cols-2">
              ...
              <ol className="space-y-5 list-none">
                {[
                  ...
                  },
                  {
                    ...
                    text: "المكيفات قيمتها ترتفع قبل الصيف. السخانات قبل الشتاء. اثاث غرف النوم يكون عليه طلب في بداية السنة الدراسية. التوقيت يفرق في السعر.",
                  },
                  {
                    title: "بيع كل شيء مع بعض",
                    text: "لو عندك اثاث بيت كامل، بيعه كحزمة وحدة. عادةً نعطي سعر أفضل للكميات الكبيرة مقارنة بالقطع المفردة.",
                  },
                ].map((tip, i) => (
                  <li
                    key={i}
            ...
            <PlaceholderImage
              alt="نصائح بيع اثاث المستعمل في العين"
              aspect="aspect-[3/4]"
        ...
        <Section bg="bg-[#f5d7cc]/15">
          ...
          <p className="mb-6 leading-relaxed">
            نشتري اثاث من جميع الماركات، لكن بعض العلامات التجارية لها قيمة
            إعادة بيع أعلى من غيرها. هنا أبرز الماركات اللي نتعامل معها:
          </p>

          <div className="mb-6 space-y-3">
            <p className="leading-relaxed">
              <strong className="text-[#413332]">اثاث منزلي:</strong> ايكيا
          ...
          <p className="mb-4 leading-relaxed">
            ...
            عندك اثاث ايكيا تبي تبيعه، غالباً بنعطيك سعر مميز.
          </p>
        ...
        <Section>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {[
              ...
              {
                quote:
                  "كنت أبي أبيع اثاث شقتي كامل لأني مسافر. تواصلت مع أكثر من جهة بس هم اللي أعطوني أعلى سعر وكانوا صريحين من البداية. ما حاولوا يساوموني.",
                name: "سارة ع.",
        ...
        <Section bg="bg-[#f5d7cc]/15">
          ...
          <p className="mb-6 leading-relaxed">
            بالإضافة لمدينة العين، نقدم خدمة شراء وبيع اثاث المستعمل في جميع
        ...
        <CTA
          ...
          desc="جاهز تبيع اثاثك المستعمل في العين؟ أو تبحث عن اثاث مستعمل بحالة ممتازة وسعر معقول؟ تواصل معنا اليوم. الخدمات الخاصة بنا مصممة لراحتك، ويمكنك الاتصال بنا في أي وقت عبر الواتساب أو الهاتف. الطريقة الأسرع هي الواتساب. أرسل لنا صور اثاث وبنرد عليك خلال دقائق بسعر واضح. أو اتصل علينا مباشرة أو عبئ نموذج التواصل في الأسفل."
        />
      </main>
    </>
  );
