...
هل تبحث عن مشتري يدفع لك سعر عادل لأثاثك المستعمل في العين؟ إذا كنت ترغب في بيع أثاثك بسرعة وبأعلى سعر، أنت في المكان الصحيح. نحن في شركة شراء اثاث مستعمل متخصصون في شراء اثاث مستعمل العين بأعلى الأسعار الممكنة. ببساطة، أرسل لنا صور الأثاث على الواتساب، وخلال دقائق نعطيك سعر واضح بدون مساومة أو تعقيد."
        />
        {/* ── trust bar ── */}
        <div className="mt-16 max-w-6xl mx-auto md:px-0 px-4">
          <div className="md:text-xl text-lg text-secondary md:px-16 leading-relaxed">
            <p className="md:inline">
              ...
              سفرة، أجهزة كهربائية، وخزائن الملابس، وأثاث مكتبي. قم ببيع أثاثك
        ...
        <Section>
          ...
          <p className="mb-10 leading-relaxed max-w-4xl">
            ...
            تبحث عن مشتري لأثاثك أو تبي تشتري قطع بحالة ممتازة، عندنا الحل. وكل
            ...
            <article className="group overflow-hidden rounded-2xl border border-[#f5d7cc] transition hover:shadow-lg">
              ...
              <div className="p-6">
                ...
                <p className="mb-3 leading-relaxed">
                  ...
                  وأي قطعة أثاث منزلي ثانية. إذا كنت ترغب في بيع اثاثك المستعمل،
        ...
        <CTA
          ...
          desc="جاهز تبيع أثاثك المستعمل في العين؟ أو تبحث عن أثاث مستعمل بحالة ممتازة وسعر معقول؟ تواصل معنا اليوم. الخدمات الخاصة بنا مصممة لراحتك، ويمكنك الاتصال بنا في أي وقت عبر الواتساب أو الهاتف. الطريقة الأسرع هي الواتساب. أرسل لنا صور الأثاث وبنرد عليك خلال دقائق بسعر واضح. أو اتصل علينا مباشرة أو عبئ نموذج التواصل في الأسفل."
        />
      </main>
    </>
  );
