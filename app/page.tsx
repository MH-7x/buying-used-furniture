...
export const metadata = MetadataTemplate({
  data: {
    meta: {
      title: "شراء اثاث مستعمل في الإمارات | بيع وشراء اثاث بأفضل الأسعار",
      desc: "شراء اثاث مستعمل في الإمارات بأفضل الأسعار. نشتري ونبيع اثاث المنزلي والمكتبي والأجهزة الكهربائية في دبي والشارقة وأبوظبي وعجمان. فك ونقل مجاني، دفع فوري، وضمان على كل قطعة. تواصل معنا الآن!",
    },
    image: {
      ...
      <main className="mt-28 overflow-hidden">
            ...
            <div className="grid gap-16 lg:grid-cols-2 items-center">
              <div className="flex flex-col gap-2 md:order-2 order-1">
                <h2 className="md:text-4xl text-3xl leading-tight font-bold mb-5">
                  حوّل اثاثك القديم إلى كاش <br />
                  فوري في 10 دقيقة
                </h2>
                <p className="md:text-lg text-base text-muted-foreground">
                  لأكثر من عشر سنوات، ساعدنا آلاف العملاء في بيع اثاث المستعمل
                ...
                <p className="md:text-lg text-base text-muted-foreground">
                  ...
                  أو تريد تجديد اثاث بيتك — تواصل معنا الآن واحصل على عرض سعر
        ...
        <section className="bg-[#413332] py-24 mt-24 text-white">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <p className="mx-auto mb-12 max-w-2xl text-center leading-relaxed text-white/80">
              عملية البيع معنا بسيطة ومباشرة. لا تحتاج تنزل من بيتك أو تبحث عن
              مشتري أو تتفاوض مع غرباء. فقط اتبع هذه الخطوات الثلاث:
            </p>
            ...
            <div className="grid gap-8 md:grid-cols-3">
              ...
              <div className="relative rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm">
                ...
                <p className="mb-3 text-sm leading-relaxed text-white/80">
                  أرسل لنا صوراً واضحة لجميع العناصر الخاصة بك من اثاث أو أجهزة
                  تريد بيعها عبر الواتساب. اذكر لنا النوع والعلامة التجارية إن
                  أمكن. فريقنا يرد خلال 5 إلى 10 دقائق — نحن من أسرع الشركات
                  رداً في السوق. يمكنك أيضاً الاتصال بنا مباشرة.
                </p>
              </div>
              ...
              <div className="relative rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm">
                ...
                <p className="mb-3 text-sm leading-relaxed text-white/80">
                  ...
                  يزور فريقنا المختص موقعك لفحص اثاث شخصياً. التقييم مجاني
                  بالكامل ولا يلزمك بشيء. نعتمد في التسعير على أربعة عوامل
                  واضحة: حالة القطعة، العلامة التجارية، عمر اثاث، والطلب الحالي
                  في السوق. بهذه الطريقة تعرف بالضبط كيف وصلنا للسعر — بدون
                  مفاجآت.
                </p>
              </div>
              ...
              <div className="relative rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm">
                ...
                <p className="mb-3 text-sm leading-relaxed text-white/80">
                  بعد الاتفاق، فريقنا يتولى كل شيء: فك اثاث بأيدي متخصصة، تغليف
                  وتحميل آمن، ونقل بسيارات مجهزة. الدفع يتم في نفس اللحظة — اختر
                  الطريقة التي تناسبك: نقداً، تحويل بنكي فوري، أو دفع أونلاين.
                  نوفر أيضاً خيار الدفع بشيك مصدّق للمبالغ الكبيرة.
                </p>
              </div>
            </div>
        ...
        <section className="max-w-4xl mt-32 mx-auto md:px-0 px-4">
          ...
          <p className="mt-10 text-muted-foreground max-w-3xl">
            شركة شراء اثاث مستعمل تأسست في دبي لتقديم حل متكامل لبيع وشراء اثاث
            المستعمل في الإمارات. بدأنا قبل أكثر من عشر سنوات برؤية واضحة: نريد
            أن نكون البديل الموثوق للأسواق العشوائية والتجار غير المرخصين.
          </p>
          ...
          <div className="mt-5">
            <div className="max-w-3xl">
              ...
              <p className="text-muted-foreground mt-5">
                رسالتنا بسيطة: نريد تحويل تجربة بيع وشراء اثاث المستعمل من عملية
                مرهقة ومليئة بعدم الثقة إلى تجربة سهلة وسريعة وآمنة. ونؤمن أن
                إعادة استخدام اثاث ليست فقط ذكاء مالي — هي أيضاً مسؤولية بيئية
                تتماشى مع أهداف الإمارات في الاستدامة.
              </p>
            </div>
          </div>
        </section>
        <section className="max-w-4xl mt-16 mx-auto md:px-0 px-4">
          ...
          <p className="mt-10 text-muted-foreground max-w-3xl">
            كل قطعة اثاث نعيد تدويرها بدل رميها هي مساهمة في حماية البيئة. في
            الإمارات، حيث معدل التنقل مرتفع وتبديل اثاث متكرر، يمكن لسوق اثاث
            المستعمل أن يقلل كميات كبيرة من النفايات.
          </p>
          <p className="mt-2 text-muted-foreground max-w-3xl">
            نحن نعمل وفق نموذج الاقتصاد الدائري: نشتري اثاث المستعمل، نجدده،
            ونعيد بيعه لعائلة جديدة. بهذه الطريقة، اثاث يستمر في الخدمة بدل أن
          ...
          <div className="mt-5">
            <div className="max-w-3xl">
              <p className="text-muted-foreground mt-5">
                عندما تبيع اثاثك لنا أو تشتري اثاثاً مستعملاً منا، أنت تساهم في
