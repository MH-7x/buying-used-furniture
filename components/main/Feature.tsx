    ...
    <div style={{}}>
      ...
      <section className="relative px-4 pb-16 pt-6 ">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            سوق اثاث المستعمل في الإمارات فيه خيارات كثيرة — بعضها جيد وبعضها
            لا. المشكلة أن أغلب الشركات في هذا المجال لا تقدم ضمانات، ولا تشرح
            كيف تقيّم الأسعار، ولا تهتم بجودة اثاث قبل إعادة بيعه. نحن نعمل
            بطريقة مختلفة. هذه أبرز الأسباب التي تجعلنا أفضل مشتري اثاث مستعمل
            ويختارنا عملاؤنا مرة بعد مرة:
          </p>
        </div>
      </section>
      ...
      <section className="relative px-4 ">
        ...
        <div className="relative z-10 max-w-6xl mx-auto grid md:grid-cols-2 grid-cols-1 gap-10">
          ...
          >
            <p>
              نحن الشركة الوحيدة في سوق اثاث المستعمل في الإمارات التي تقدم
              ضمان على اثاث المبيع. إذا اشتريت قطعة اثاث منا ولم تكن راضياً
          ...
          >
            <p>
              من أكبر المخاوف عند شراء اثاث مستعمل: النظافة. هل الكنب نظيف؟ هل
              في حشرات؟ هل الخشب متضرر؟ عندنا، كل قطعة اثاث تمر بعملية تعقيم
            ...
            <div className="mt-4 space-y-1">
              ...
              <BulletItem>
                معالجة ضد الحشرات لضمان خلو اثاث من أي مشاكل
              </BulletItem>
            ...
            >
              النتيجة: اثاث مستعمل بحالة ممتازة، نظيف وآمن، جاهز للاستخدام
              فوراً.
            </div>
          </FeatureCard>
          ...
          >
            ...
            <p className="mt-3">
              نشرح لك بالضبط كيف نقيّم اثاثك بناءً على أربعة معايير واضحة: حالة
              القطعة (ممتاز — جيد — مقبول)، العلامة التجارية، عمر اثاث، والطلب
          ...
          >
            <p>
              الدفع يتم نقداً أو عن طريق تحويل بنكي مباشر، دفع أونلاين، أو شيك
          ...
          >
            <p>
              عندما نشتري اثاثك، لا نطلب منك فك أي شيء أو إنزاله للسيارة. فريقنا
              من النقل والتغليف يتولى كل شيء. نستخدم أدوات احترافية لفك اثاث
          ...
          {/* 6 — Coverage */}
          <FeatureCard
            title="تغطية جميع الإمارات من مقرنا في دبي"
            icon={
              <svg
                width="26"
                height="26"
          ...
          >
            <p>
              مقرنا في دبي يتيح لنا خدمة سريعة في الشارقة وعجمان ودبي خلال
              ساعات. أبوظبي والعين ورأس الخيمة والفجيرة وأم القيوين — نصل إليها
              خلال يوم عمل واحد.
            </p>
            <p className="mt-3">
              نحن لسنا شركة أونلاين فقط — لدينا معرض فعلي في دبي يمكنك زيارته
              والاطلاع على المعروضات بنفسك.
            </p>
          </FeatureCard>
        </div>
      </section>
