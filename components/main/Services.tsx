...
const features = [
  {
    ...
    details:
      "نشتري كل ما يخص المنزل: أطقم كنب ومجالس عربية، غرف نوم كاملة بالسرير والخزانة والتسريحة، طاولات طعام مع الكراسي، خزائن أحذية، سجاد، ستائر، وديكورات. سواء كان اثاثك من ايكيا أو هوم سنتر أو دانوب أو أي علامة تجارية أخرى — نشتريه بسعر عادل. نوفر أيضاً اثاث مستعمل للبيع بحالة ممتازة بعد عملية الفحص والتجديد.",
  ...
  },
  {
    ...
    details:
      "إذا كنت تصفّي مكتباً أو تنتقل لمقر جديد، نشتري جميع أنواع اثاث المكتبي المستعمل: مكاتب بجميع الأحجام، كراسي مكتب عادية وإرجونوميك، طاولات اجتماعات، خزائن ملفات، أرفف عرض، وكاونترات استقبال. نتعامل مع الشركات الصغيرة والكبيرة ونقدم خدمة تصفية كاملة بأسعار مناسبة.",
  ...
  {
    title: "شراء اثاث الفنادق والمطاعم",
    details:
      "نقدم خدمة شراء اثاث فنادق مستعمل بالجملة — من غرف النوم الفندقية إلى صالات الانتظار واثاث المطاعم والكافيهات. إذا كنت تجدد فندقاً أو تغلق مطعماً، نشتري كل شيء بأسعار مناسبة مع خدمة إخلاء سريعة. هذه الخدمة متاحة في جميع الإمارات.",
  ...
  },
  {
    ...
    details:
      "بالإضافة للاثاث، نشتري الإلكترونيات والأدوات المنزلية المستعملة: أجهزة كمبيوتر ولابتوبات، طابعات، أدوات مطبخ كهربائية، ومعدات تنظيف. إذا ما كنت متأكد إذا نشتري القطعة اللي عندك — أرسل لنا صورة على الواتساب وبنرد عليك خلال دقائق.",
    tutorialLink: "/شراء-الالكترونيات-المستعملة",
    src: "/شراء-الإلكترونيات-والأدوات-المنزلية.jpg",
  },
  {
    title: "شراء اثاث الحدائق واثاث الخارجي",
    details:
      "الجلسات الخارجية، اثاث الحدائق، المظلات، الأراجيح، وطاولات البلكونات — كلها مطلوبة ونشتريها. إذا عندك اثاث خارجي بحالة جيدة، تواصل معنا وسنقدم لك عرض سعر فوري.",
    tutorialLink: "/شراء-الأثاث-المنزلي",
    ...
    <div className="flex  mt-32 items-center justify-center">
      <div className="w-full max-w-6xl px-4 py-10">
        <h2 className="font-semibold text-3xl  sm:mx-auto sm:max-w-2xl sm:text-center md:text-[2.75rem] md:leading-[1.3]">
          نشتري جميع أنواع اثاث المستعمل والأجهزة الكهربائية
        </h2>
        <p className="mt-5 text-lg text-muted-foreground sm:text-center sm:text-xl max-w-4xl mx-auto">
          مهما كان نوع اثاث أو الأجهزة المستعملة التي تريد بيعها، نحن نشتري كل
          شيء. فريقنا متخصص في تقييم جميع الفئات ونقدم أسعاراً عادلة تعكس القيمة
