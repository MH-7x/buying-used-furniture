...
const InspectionProcess = () => {
  ...
  const introText =
    "نحن لا نشتري اثاث لنعيد بيعه كما هو. كل قطعة تمر بعملية فحص وتجديد متكاملة حتى تصل للمشتري النهائي بأفضل حال. هذا ما يميزنا عن شركات اثاث المستعمل التي تنقل القطع من بيت لبيت بدون أي اهتمام بالجودة.";
  ...
  const phases = [
    ...
    },
    {
      ...
      description:
        "بعد الإصلاح، تمر القطعة بعملية تلميع: معالجة الخشب، تنظيف المعادن، إعادة صبغ إذا لزم الأمر. الهدف أن يبدو اثاث بأفضل حال قدر الإمكان..",
      icon: Sparkles,
    },
    {
      id: 4,
      ...
      description:
        "هذه المرحلة مهمة جداً وخصوصاً للمفروشات المنجدة مثل الكنب والمجالس والمراتب. نستخدم مواد تعقيم آمنة ومعتمدة للقضاء على أي بكتيريا أو حشرات. الأقمشة تنظف بالبخار، والأسطح الصلبة تعالج بمواد مطهرة. النتيجة: اثاث مستعمل خالٍ من أي مشاكل صحية.",
      icon: ShieldCheck,
    },
    {
      id: 5,
