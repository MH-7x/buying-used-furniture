...
const locations = [
  ...
  },
  {
    ...
    description:
      "قرب مقرنا من عجمان يعني خدمة سريعة لسكان الإمارة. نشتري اثاث مستعمل عجمان من جميع المناطق ونوفر اثاث مستعمل للبيع في عجمان أيضاً. يمكنك التواصل معنا لشراء أو بيع اثاث في أي منطقة بعجمان.",
  ...
  },
  {
    ...
    description:
      "أبوظبي ومصفح من أكبر أسواق اثاث المستعمل في الإمارات. نقدم خدمة شراء اثاث مستعمل ابوظبي في المصفح، مدينة خليفة، جزيرة الريم، المرور، والخالدية. إذا كنت تبحث عن محلات شراء الاثاث المستعمل في ابوظبي، نحن خيارك الموثوق.",
  ...
  },
  {
    ...
    description:
      "العين أيضاً من المناطق التي نخدمها بشكل ممتاز. نشتري ونبيع اثاث مستعمل العين في كل المناطق، ونوفر خدمة نقل سريعة ومجانية. إذا كنت في العين وتبحث عن شراء اثاث مستعمل العين أو بيع اثاثك القديم، تواصل معنا وسنقدم لك أفضل عرض.",
  ...
  },
  {
    ...
    description:
      "نشتري ونبيع اثاث مستعمل في رأس الخيمة. نوصل لجميع المناطق، ونعطيك سعر عادل بدون مساومة. تواصل معنا على الواتساب وراح نرد عليك بسرعة.",
      ...
      <div className="mt-10 grid lg:grid-cols-2  grid-cols-1 gap-10">
        <div className="items-center grid grid-cols-4 gap-x-5 bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 overflow-hidden transition-all duration-300 hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] hover:-translate-y-1 p-6">
          ...
          <div className="md:col-span-3 col-span-full md:mt-0 mt-5">
            ...
            <p className="mt-2 text-muted-foreground text-[15px] leading-relaxed">
              خدمتنا توصل للفجيرة. نشتري كل أنواع اثاث المنزلي والمكتبي.
        ...
        <div className="items-center grid grid-cols-4 gap-x-5 bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 overflow-hidden transition-all duration-300 hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] hover:-translate-y-1 p-6">
          ...
          <div className="md:col-span-3 col-span-full md:mt-0 mt-5">
            ...
            <p className="mt-2 text-muted-foreground text-[15px] leading-relaxed">
              نخدم أم القيوين في شراء وبيع اثاث المستعمل. أسعار منافسة، وفريق
              نقل محترف. راسلنا وأرسل صور للاثاث، وراح نعطيك عرض سعر خلال دقائق
            </p>
          </div>
        </div>
      </div>
