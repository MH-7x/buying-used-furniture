...
const locations = [
  {
    ...
    description:
      "الشارقة هي قاعدتنا ونعرف كل حي فيها. نقدم خدمة فورية في النهدة، المويلح، المجاز، أبو شغارة، الرولة، التعاون، المنطقة الصناعية، والقاسمية. إذا كنت في الشارقة وتبحث عن سوق الشارقة للاثاث المستعمل أو محل موثوق لشراء الاثاث المستعمل في الشارقة، يمكنك زيارة معرضنا مباشرة.",
  ...
  return (
    <section id="locations" className="max-w-6xl mx-auto mt-36 md:px-0 px-4">
      <h2 className="md:text-4xl text-3xl font-bold text-secondary mb-5 max-w-xl leading-tight">
        نخدم جميع مناطق الإمارات — من الشارقة إلى الفجيرة
      </h2>
      <p className="text-muted-foreground max-w-3xl">
        واحدة من أهم مميزاتنا هي التغطية الشاملة لجميع إمارات الدولة. مقرنا
        الرئيسي في الشارقة يتيح لنا الوصول السريع لأغلب المناطق، ونوفر خدمة شراء
