          ...
          <div className="space-y-6 order-1 lg:order-2">
            <div className=" p-6 border-b-2 border-primary">
              ...
              <p className="text-muted-foreground leading-relaxed ">
                سوق شراء اثاث المستعمل في ابوظبي فيه خيارات كثيرة. في تجار على
                الشارع، وفي إعلانات مبوبة، وفي شركات نقل تشتري اثاث كخدمة
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="mt-6 text-muted-foreground text-lg max-w-4xl mx-auto leading-relaxed">
              كل قطعة اثاث نشتريها تمر بفحص احترافي يشمل تقييم الحالة العامة،
        ...
        <div className="max-w-6xl mx-auto px-4  grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
          ...
          >
            <Image
              ...
              alt=" أفضل شركة لشراء اثاث المستعمل"
              fill
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-white p-8 rounded-2xl ">
            ...
            <p className="text-gray-600 leading-relaxed">
              يعني فريقنا يحمي الممرات والمصاعد والأبواب أثناء نقل اثاث. شركات
              النقل الصغيرة قد تسبب خدوش وأضرار للعقار، لكن مع فريقنا، هذا لا
              يحصل. نتعامل مع اثاثك وعقارك باحترام كامل.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-2xl ">
            ...
            <p className="text-gray-600 leading-relaxed">
              نقطة أخيرة مهمة: نحن لسنا شركة نقل تشتري اثاث كخدمة جانبية. نحن
              شركة متخصصة في تجارة اثاث المستعمل. هذا معناه أننا نفهم القيمة
